...
public class Log2Aspect {
    private static final Logger LOGGER = LoggerFactory.getLogger(Log2Aspect.class);
    ...
    @Pointcut("@annotation(com.github.yu.autoconfigure.log.RequestLog2)")
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        RequestLog2 requestLog = method.getAnnotation(RequestLog2.class);
        ...
        BaseService service = context.getBean(requestLog.service());
